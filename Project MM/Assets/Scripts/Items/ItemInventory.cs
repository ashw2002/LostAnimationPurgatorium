...
//        Debug.Log(canCollect);
    ...
    public void CreateInventoryContainer(string s){
        ...
        {
            ErrorLog.ErrorDebugTxt(ex.Message);
        }
        ...
        if (canCollect == true && InventoryOpen == false)
        {
            if (Input.GetKeyDown(KeyCode.Space))
            {
                if(currentCollectable.name == "Coin"){
                    ...
                    ErrorLog.InfoDebugTxt("Coin Collected, Count: " + coins);
                    ...
                    canCollect = false;
                    ErrorLog.InfoDebugTxt("Collected Item, Game Object Name: " + currentCollectable.name);
    ...
    public void OpenInventory(){
        ErrorLog.InfoDebugTxt("Inventory Status: " + InventoryOpen);
        ErrorLog.InfoDebugTxt("Items:" + System.String.Join(",", items));
